  ...
  return (
    <>
      <div className="relative">
        <button
          className="bg-boa-dark-blue p-[0.4rem] sm:mr-[4rem] max-sm:mr-[0.6rem] ml-[1re] rounded-[50%] mt-[0.4rem] hover:translate-y-0.5 transition-all ease cursor-pointer text-white min-w-[2.2rem] absolute md:top-4 md:left-4"
      ...
      <div>
        ...
        <div>
            ...
            <div className="flex flex-col gap-2">
              ...
              >
                {countries?.map((item, index) => {
                  return (
                    <option key={index} value={item?.id} name="id_country">
                      {item?.name}
                    </option>
                  );
                })}
              ...
              <div className="flex flex-col gap-2">
                ...
                >
                  {towns?.map((item, index) => {
                    return (
                      <option key={index} value={item?.id} name="id_town">
                        {item?.name}
                      </option>
                    );
                  })}
          ...
          <div className="termsAgree flex items-center md:w-[70%]">
            ...
            />
            <label htmlFor="set_default" className="max-md:text-xs text-black ">
        ...
        <div>
          ...
          <div className="mt-4">
            <button
              ...
              className="bg-[#191919] text-white py-[0.8rem] px-[2rem] hover:bg-opacity-80 max-sm:ml-auto max-sm:mt-[2rem] max-sm:block"
            >
              Sačuvaj izmene
            </button>
          </div>
